...
RSpec.shared_examples_for 'an actions matcher' do
  ...
  it 'initializes expected actions with multiple actions and sorts them' do
...
RSpec.shared_examples_for 'a matcher without negative expectation' do |with_args: false|
  describe '#does_not_match?' do
    ...
    it 'raises a not implemented error' do
      ...
      end.to raise_error NotImplementedError, described_class::NOT_SUPPORTED_ERROR
    end
  end
end
